...
var _ datasource.DataSource = (*infraapiEndpointDataSource)(nil)

func NewinfraapiEndpointDataSource() datasource.DataSource {
	return &infraapiEndpointDataSource{}
}

type infraapiEndpointDataSource struct{}

func (d *infraapiEndpointDataSource) Metadata(_ context.Context, _ datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *infraapiEndpointDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *infraapiEndpointDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var model modelV0
	...
	requestGetURL := requestURL + "/" + model.Endpoint.ValueString()
	if method == "" {
		method = "GET"
	}
	...
	request, err := retryablehttp.NewRequestWithContext(ctx, method, requestGetURL, requestBody)
	if err != nil {
		resp.Diagnostics.AddError(
